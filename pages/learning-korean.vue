...
onMounted(async () => {
  try {
    ...
    if (data && data.koreanTasksDate === today && data.koreanTasks) {
      tasks.value = data.koreanTasks
    } else {
      // New day, reset tasks
      resetTasks()
    }
  } catch (error) {
    console.error('Failed to load Korean tasks:', error)
  }
})
...
const saveTasks = async () => {
  try {
    ...
    await $fetch('/api/user-data', {
      ...
      body: {
        ...currentData,
        koreanTasks: tasks.value,
        koreanTasksDate: today
      }
    })
  } catch (error) {
    console.error('Failed to save Korean tasks:', error)
  }
}
...
<template>
  <div class="learning-page">
    <header class="page-header">
      <h1 class="title">🇰🇷 Learning Korean</h1>
      <p class="subtitle">Track your daily Korean learning tasks</p>
    </header>
    ...
    <div class="content-wrapper">
      ...
      <div class="tasks-section">
        ...
        <div v-if="tasks.length === 0" class="empty-state">
          <p>No tasks yet. Add your first Korean learning task!</p>
        </div>
